...
The latest release is 0.13.0 and requires oc >= v3.9.0. OpenShift 4 is not supported yet.
Please have a look at the [changelog](https://github.com/opendevstack/tailor/blob/master/CHANGELOG.md) when upgrading.

MacOS:

```
curl -LO "https://github.com/opendevstack/tailor/releases/download/v0.13.0/tailor-darwin-amd64" && \
...
```
curl -LO "https://github.com/opendevstack/tailor/releases/download/v0.13.0/tailor-linux-amd64" && \
...
```
curl -LO "https://github.com/opendevstack/tailor/releases/download/v0.13.0/tailor-windows-amd64.exe" && \
