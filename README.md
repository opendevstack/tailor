...
The latest release is 0.9.1 and requires oc >= v3.9.0.
Please have a look at the [changelog](https://github.com/opendevstack/tailor/blob/master/CHANGELOG.md) when upgrading.

MacOS:

```
curl -LO "https://github.com/opendevstack/tailor/releases/download/v0.9.1/tailor_darwin_amd64" && \
...
```
curl -LO "https://github.com/opendevstack/tailor/releases/download/v0.9.1/tailor_linux_amd64" && \
...
```
curl -LO "https://github.com/opendevstack/tailor/releases/download/v0.9.1/tailor_windows_amd64.exe" && \
