...
The latest release is 1.1.0 and requires oc >= v3.9.0. OpenShift 4 is not officially supported yet although 1.0.0 and above work in principle.
Please have a look at the [changelog](https://github.com/opendevstack/tailor/blob/master/CHANGELOG.md) when upgrading.

MacOS:

```
curl -LO "https://github.com/opendevstack/tailor/releases/download/v1.1.0/tailor-darwin-amd64" && \
...
```
curl -LO "https://github.com/opendevstack/tailor/releases/download/v1.1.0/tailor-windows-amd64.exe" && \
