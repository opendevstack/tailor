...
```
curl -LO "https://github.com/opendevstack/tailor/releases/download/v1.3.0/tailor-darwin-amd64" && \
...
```
curl -LO "https://github.com/opendevstack/tailor/releases/download/v1.3.0/tailor-linux-amd64" && \
...
```
curl -LO "https://github.com/opendevstack/tailor/releases/download/v1.3.0/tailor-windows-amd64.exe" && \
